...
public class AuthQuery {
    ...
    public static final String AUTH_SEL_ACCOUNT_INFO = "SELECT id, uuid, username, password, salt, date_ban_end, token FROM accounts WHERE username = ?";
    public static final String AUTH_UPD_ACCOUNT_TOKEN = "UPDATE accounts SET token = ? WHERE id = ?";
    public static final String AUTH_UPD_ACCOUNT_LAST_LOGIN = "UPDATE accounts SET last_logged_in = ? WHERE id = ?";
